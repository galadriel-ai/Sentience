...
class EnclaveRepository:
    ...
    def get_enclave(self, enclave_cid: str) -> Enclave:
        return self._enclaves.get(enclave_cid)

    def get_all_enclaves(self) -> Dict[str, Enclave]:
        return self._enclaves

    def add_enclave(self, enclave_cid: str, enclave_name: str, state: str):
    ...
    def remove_enclave(self, enclave_cid: str):
        if enclave_cid in self._enclaves:
            ...
            self._stop_enclave_proxy(enclave_cid)
    ...
    def _stop_enclave_proxy(self, enclave_cid: str):
        self._enclaves[enclave_cid].proxy_task.cancel()
        self._enclaves[enclave_cid].proxy_task = None
